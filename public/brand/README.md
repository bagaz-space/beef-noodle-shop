...
Final logo/lock-up files from the designer go here once delivered:

- `logo-primary.svg` — full lock-up, EN + Chinese
- `logo-horizontal.svg`
- `logo-stacked.svg`
- `logo-icon.svg` — monogram, used for `app/icon.png` / favicon / app tile
- `logo-reversed.svg` — knockout, for dark backgrounds
